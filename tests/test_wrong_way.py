...
def test_wrong_way_default():
    ...
    trajectory_ok = [[100, 100], [120, 100]]
    assert not detector.check_violation(track_id=1, trajectory=trajectory_ok)

    # Moving opposite to the allowed direction (displacement 20 > 15)
    trajectory_wrong = [[100, 100], [80, 100]]
...
def test_wrong_way_vertical():
    ...
    # Moving downward
    trajectory_ok = [[100, 100], [100, 120]]
    assert not detector.check_violation(track_id=3, trajectory=trajectory_ok)

    # Moving upward (opposite) (displacement 20 > 15)
    trajectory_wrong = [[100, 100], [100, 80]]
